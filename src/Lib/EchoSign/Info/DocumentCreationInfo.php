...
use EchoSign\Options\SecurityOptions;
...
class DocumentCreationInfo extends AbstractCreationInfo
    {
        ...
        function setMergeFieldInfo(MergeFieldInfo $fieldInfo)
        {
         ...
         */
        public function setSecurityOptions(SecurityOptions $securityOptions)
        {
