...
class API{
        ...
        {
            $result = $this->client->getBaseUris(["apiKey" => $this->api_key]);
            return $result;
        }
        #Document Methods
    ...
    #Widget Methods
         ...
         * 
         */        
        function createUrlWidget(WidgetCreationInfo $widget, SenderInfo $sender = null){
    ...
    #Accessors
        ...
        static function setWSDL($wsdl){
            ...
            if(!filter_var($wsdl, FILTER_VALIDATE_URL)) {
                throw new \InvalidArgumentException($wsdl . ' does not appear to be a valid Url');
            }
